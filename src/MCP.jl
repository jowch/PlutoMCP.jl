...
const MCP_TOOLS = [
    ...
    Dict{String,Any}(
        ...
        "inputSchema" => Dict{String,Any}(
            ...
            "properties" => Dict{String,Any}(
                ...
                "folded"        => Dict("type" => "boolean", "description" => "Hide the new cell's code, showing only its output (Pluto fold). Use for markdown/prose cells. Default: false. Folded cells whose code starts with md are omitted from the default read_notebook_code projection."),
            ),
    ...
    Dict{String,Any}(
        "name"        => "fold_cell",
        "description" => "Fold or unfold a cell: folded hides the code editor and shows only the output (Pluto's eye toggle). Metadata only; nothing runs. Persisted in the notebook file. Folding a cell whose code starts with md can hide it from the default read_notebook_code projection.",
        "inputSchema" => Dict{String,Any}(
            "type"       => "object",
            "properties" => Dict{String,Any}(
                "notebook_id" => Dict("type" => "string", "description" => "The notebook UUID."),
